...
public class WoolFurShaderGUI : BaseShaderGUI
{
    // Properties
    ...
    private MaterialProperty shapeValueProp         = null;
    private MaterialProperty fresnelColorProp       = null;
    private MaterialProperty sssColorProp          = null;
    private MaterialProperty rimSizeProp            = null;
    private MaterialProperty rimIntensityProp       = null;
    ...
    public override void FindProperties(MaterialProperty[] properties)
    {
        ...
        // ADDTIONAL
        shapeValueProp         = FindProperty("_Shape",   properties);
        fresnelColorProp       = FindProperty("_FresnelColor",   properties);
        sssColorProp       = FindProperty("_SSSColor",   properties);
        rimSizeProp            = FindProperty("_RimSize",   properties);
        rimIntensityProp       = FindProperty("_RimIntensity",   properties);
    ...
    public override void DrawAdditionalFoldouts(Material material)
    {
        ...
        {
            materialEditor.RangeProperty(shapeValueProp,   "Shape");
            materialEditor.ColorProperty(fresnelColorProp, "Fresnel Color");
            materialEditor.RangeProperty(rimSizeProp     , "rimSize");
            materialEditor.RangeProperty(rimIntensityProp, "rimIntensity");
