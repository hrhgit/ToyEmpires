...
inline void InitializeStandardLitSurfaceData(float2 uv, half outlineAlpha,out SurfaceData outSurfaceData)
{
    half4 albedoAlpha = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_MainTex, sampler_MainTex));

    outSurfaceData.alpha = Alpha(saturate(albedoAlpha.a+outlineAlpha), _BaseColor, _Cutoff);
